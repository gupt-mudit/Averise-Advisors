        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 sm:mx-5 md:mx-20 mt-16 p-16 gap-5">
            <div className="hidden lg:block lg:m-auto">
                <img
                    src={AboutImg}
                    alt="Code Image"
                    className="w-3/4 rounded-full transition-filter duration-700 ease-in-out hover:grayscale-0"
                />
            </div>
            <div className="flex flex-col text-center lg:text-left items-center lg:items-start">
                <h1 className="text-4xl lg:text-5xl tracking-wide">ABOUT US</h1>
                <h1 className="mt-10 py-2 text-3xl lg:text-4xl tracking-widest bg-gradient-to-r from-green-500 to-green-900 text-transparent bg-clip-text">
                    Your Partner in Navigating Global Taxation and Compliance
                </h1>
                <p className="text-lg mt-12 max-w-5xl">
